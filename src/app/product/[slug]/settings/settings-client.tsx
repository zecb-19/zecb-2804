    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <div className="text-xs text-slate-900-variant">Name</div>
            <div className="text-sm text-slate-900 font-medium">{name}</div>
          </div>
          <div>
            <div className="text-xs text-slate-900-variant">Email</div>
            <div className="text-sm text-slate-900 font-medium">{email}</div>
          </div>
          <div>
            <div className="text-xs text-slate-900-variant">Plan</div>
            <div className="text-sm text-slate-900 font-medium capitalize">{plan}</div>
          </div>
          <div>
            <div className="text-xs text-slate-900-variant">Member since</div>
      ...
      <form action={action} className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
        ...
        <p className="text-slate-900-variant text-sm">
        ...
        <div className="flex items-center gap-3">
          <button type="submit" disabled={pending} className="px-4 py-2.5 rounded-lg bg-slate-900 text-white font-semibold text-sm hover:opacity-90 disabled:opacity-60">
